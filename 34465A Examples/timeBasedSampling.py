...
v34465A.write(':SAMPle:COUNt %d' % (100))                                   # Total number of samples to be collected
v34465A.write(':SAMPle:SOURce %s' % ('TIMer'))                              # Sample based on timer
v34465A.write(':SAMPle:TIMer %s' % ('0.1'))                                 # Set timer to 100ms
v34465A.write(':TRIGger:SOURce %s' % ('IMMediate'))                         # Begin collecting data immediatly 
